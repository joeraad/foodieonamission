!(function (e, t) {
	...
	function a(e) {
		var t = {};
		return (
			pe.each(e.match(ke) || [], function (e, n) {
				t[n] = !0;
			}),
			t
		);
	...
	function v(e, t) {
		for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
			(i = e[o]).style &&
				...
				t
					? ("none" === n &&
							((r[o] = Le.get(i, "display") || null),
							r[o] || (i.style.display = "")),
					  "" === i.style.display && We(i) && (r[o] = g(i)))
					: "none" !== n && ((r[o] = "none"), Le.set(i, "display", n)));
	...
	function A(e, t) {
		...
		if (1 === t.nodeType) {
			if (
				Le.hasData(e) &&
				((o = Le.access(e)), (s = Le.set(t, o)), (c = o.events))
			) {
			...
			qe.hasData(e) &&
				((a = qe.access(e)), (l = pe.extend({}, a)), qe.set(t, l));
		}
	}
	function k(e, t) {
	...
	function D(e, t, i, r) {
		...
		if (m || (d > 1 && "string" == typeof p && !de.checkClone && tt.test(p)))
			return e.each(function (n) {
				var o = e.eq(n);
				m && (t[0] = p.call(this, n, o.html())), D(o, t, i, r);
			});
		if (
			d &&
			((o = w(t, e[0].ownerDocument, !1, e, r)),
			(s = o.firstChild),
			1 === o.childNodes.length && (o = s),
			s || r)
		) {
			for (l = (a = pe.map(y(o, "script"), j)).length; f < d; f++)
				(c = o),
					f !== h &&
						((c = pe.clone(c, !0, !0)), l && pe.merge(a, y(c, "script"))),
					i.call(e[f], c, f);
			if (l)
				for (u = a[a.length - 1].ownerDocument, pe.map(a, S), f = 0; f < l; f++)
					(c = a[f]),
						Qe.test(c.type || "") &&
	...
	function N(e, t, n) {
		for (var i, r = t ? pe.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
			n || 1 !== i.nodeType || pe.cleanData(y(i)),
				i.parentNode &&
					(n && pe.contains(i.ownerDocument, i) && b(y(i, "script")),
	...
	function H(e, t, n, i, r) {
		...
		for (
			...
			"margin" === n && (s += pe.css(e, n + Fe[o], !0, r)),
				i
					? ("content" === n && (s -= pe.css(e, "padding" + Fe[o], !0, r)),
					  "margin" !== n &&
							(s -= pe.css(e, "border" + Fe[o] + "Width", !0, r)))
					: ((s += pe.css(e, "padding" + Fe[o], !0, r)),
					  "padding" !== n &&
							(s += pe.css(e, "border" + Fe[o] + "Width", !0, r)));
		return s;
	}
	function R(e, t, n) {
		...
		return ot.test(o)
			? o
			: ((i = s && (de.boxSizingReliable() || o === e.style[t])),
			  "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
			  (o = parseFloat(o) || 0) +
					H(e, t, n || (s ? "border" : "content"), i, r) +
					"px");
	}
	...
	function U(e, t) {
		...
		for (t = t ? 1 : 0; i < 4; i += 2 - t)
			(n = Fe[i]), (r["margin" + n] = r["padding" + n] = e);
	...
	function $(e, t, n) {
		...
		for (K(u, c.opts.specialEasing); o < s; o++)
			if ((i = $.prefilters[o].call(c, e, u, c.opts)))
				return (
				...
				if (null != (e = arguments[a]))
					for (t in e)
						(n = s[t]),
							(i = e[t]),
							s !== i &&
								(c && i && (pe.isPlainObject(i) || (r = Array.isArray(i)))
									? (r
	...
	var be = (function (e) {
		function t(e, t, n, i) {
			...
			if (
				!i &&
				((t ? t.ownerDocument || t : M) !== N && D(t), (t = t || N), I)
			) {
				if (11 !== p && (l = me.exec(e)))
					if ((r = l[1])) {
						if (9 === p) {
				...
				if (w.qsa && !K[e + " "] && (!L || !L.test(e))) {
					if (1 !== p) (h = t), (d = e);
						...
						for (
							...
							u[o] = "#" + a + " " + f(u[o]);
						(d = u.join(",")), (h = (ge.test(e) && c(t.parentNode)) || t);
					}
					if (d)
						try {
			...
			return (
				...
				i(function (i, s, a, l) {
					var c,
						...
						b = n ? (o || (i ? e : g || r) ? [] : s) : y;
					if ((n && n(y, b, a, l), r))
						for (c = m(b, h), r(c, [], a, l), u = c.length; u--; )
							(f = c[u]) && (b[h[u]] = !(y[h[u]] = f));
					if (i) {
						if (o || e) {
							if (o) {
			...
			var r = n.length > 0,
				...
				s = function (i, s, a, l, c) {
					...
					for (
						...
						if (o && u) {
							for (
								f = 0, s || u.ownerDocument === N || (D(u), (a = !I));
								(d = e[f++]);
			...
			(D = t.setDocument = function (e) {
				...
				return i !== N && 9 === i.nodeType && i.documentElement
					? ((N = i),
					  ...
					  (w.getElementsByClassName = pe.test(N.getElementsByClassName)),
					  ...
					  (q = []),
					  (L = []),
					  (w.qsa = pe.test(N.querySelectorAll)) &&
							(r(function (e) {
		...
		return (
			...
			(w.sortStable = R.split("").sort($).join("") === R),
		...
		if (((n = n || Ce), "string" == typeof e)) {
			...
			if (i[1]) {
				if (
					...
					pe.merge(
						this,
						pe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)
					),
			...
			return (
				(r = te.getElementById(i[2])) && ((this[0] = r), (this.length = 1)),
				this
			);
		}
		return e.nodeType
			...
			function (e, t) {
				pe.fn[e] = function (n, i) {
					...
					return (
						...
						this.length > 1 &&
							(Ae[e] || pe.uniqueSort(r), Se.test(e) && r.reverse()),
						this.pushStack(r)
					);
				};
			}
								...
								return function () {
											...
											: function () {
													try {
														...
														pe.Deferred.exceptionHook &&
															pe.Deferred.exceptionHook(e, d.stackTrace),
															t + 1 >= s &&
																(i !== c && ((a = void 0), (u = [e])),
																n.rejectWith(a, u));
													}
									...
									t
										...
										: (pe.Deferred.getStackHook &&
												(d.stackTrace = pe.Deferred.getStackHook()),
										  e.setTimeout(d));
								};
							}
							var s = 0;
		...
		pe.extend({
			...
			ready: function (e) {
				(!0 === e ? --pe.readyWait : pe.isReady) ||
					((pe.isReady = !0),
					(!0 !== e && --pe.readyWait > 0) || Ne.resolveWith(te, [pe]));
			},
		}),
		(pe.ready.then = Ne.then),
				...
				if (void 0 !== i) {
					if (void 0 !== t) {
						Array.isArray(t)
							...
							: ((t = pe.camelCase(t)), (t = t in i ? [t] : t.match(ke) || [])),
							(n = t.length);
						for (; n--; ) delete i[t[n]];
					}
		...
		pe.fn.extend({
			data: function (e, t) {
				...
				if (void 0 === e) {
					if (
						this.length &&
						((r = qe.get(o)), 1 === o.nodeType && !Le.get(o, "hasDataAttrs"))
					) {
						for (n = s.length; n--; )
							s[n] &&
			...
			queue: function (e, t, n) {
				...
				if (e)
					return (
						...
						n &&
							(!i || Array.isArray(n)
								? (i = Le.access(e, t, pe.makeArray(n)))
								: i.push(n)),
						i || []
					);
			},
	...
	pe.extend({
		...
		clone: function (e, t, n) {
			...
			if (
				...
				for (s = y(a), o = y(e), i = 0, r = o.length; i < r; i++) k(o[i], s[i]);
			if (t)
				if (n)
					for (o = o || y(e), s = s || y(a), i = 0, r = o.length; i < r; i++)
						A(o[i], s[i]);
				else A(e, a);
			...
			pe.cssHooks[t] = {
				...
				set: function (e, n, i) {
					var r,
						...
						s =
							i &&
							H(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, o), o);
					return (
						s &&
							(r = Me.exec(n)) &&
							"px" !== (r[3] || "px") &&
	...
	(pe.Animation = pe.extend($, {
		...
		tweener: function (e, t) {
			pe.isFunction(e) ? ((t = e), (e = ["*"])) : (e = e.match(ke));
			...
			stop: function (e, t, n) {
				...
				return (
					...
					this.each(function () {
						...
						else for (r in s) s[r] && s[r].stop && gt.test(r) && i(s[r]);
						for (r = o.length; r--; )
							o[r].elem !== this ||
								(null != e && o[r].queue !== e) ||
			...
			toggleClass: function (e, t) {
				...
				return "boolean" == typeof t && "string" === n
					...
					: this.each(function () {
							var t, i, r, o;
							if ("string" === n)
								for (i = 0, r = pe(this), o = e.match(ke) || []; (t = o[i++]); )
									r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
							else
								(void 0 !== e && "boolean" !== n) ||
									((t = z(this)) && Le.set(this, "__className__", t),
									this.setAttribute &&
										this.setAttribute(
											"class",
		...
		trigger: function (t, n, i, r) {
			...
			if (
				...
				if (!r && !f.noBubble && !pe.isWindow(i)) {
					for (
						l = f.delegateType || h, xt.test(l + h) || (s = s.parentNode);
						s;
						s = s.parentNode
					)
						d.push(s), (a = s);
				...
				for (o = 0; (s = d[o++]) && !t.isPropagationStopped(); )
					(t.type = o > 1 ? l : f.bindType || h),
						(u = (Le.get(s, "events") || {})[t.type] && Le.get(s, "handle")) &&
							u.apply(s, n),
						(u = c && s[c]) &&
							u.apply &&
							Ie(s) &&
		...
		pe.extend({
			...
			ajax: function (t, n) {
						...
						c
							? (p.ifModified &&
									((_ = E.getResponseHeader("Last-Modified")) &&
										(pe.lastModified[o] = _),
									(_ = E.getResponseHeader("etag")) && (pe.etag[o] = _)),
							  204 === t || "HEAD" === p.type
									? (x = "nocontent")
									: 304 === t
									? (x = "notmodified")
									: ((x = w.state), (d = w.data), (h = w.error), (c = !h)))
							: ((h = x), (!t && x) || ((x = "error"), t < 0 && (t = 0))),
						(E.status = t),
						(E.statusText = (n || x) + ""),
						c ? v.resolveWith(m, [d, x, E]) : v.rejectWith(m, [E, x, h]),
						E.statusCode(b),
						(b = void 0),
				...
				if (
					...
					(p.dataTypes = (p.dataType || "*").toLowerCase().match(ke) || [""]),
					null == p.crossDomain)
				) {
	...
	pe.ajaxSetup({
		...
		pe.each(["top", "left"], function (e, t) {
			pe.cssHooks[t] = I(de.pixelPosition, function (e, n) {
				if (n)
					return (n = O(e, t)), ot.test(n) ? pe(e).position()[t] + "px" : n;
			});
		}),
	...
	return (
		(pe.noConflict = function (t) {
			return (
				e.$ === pe && (e.$ = Qt), t && e.jQuery === pe && (e.jQuery = $t), pe
			);
		}),
		t || (e.jQuery = e.$ = pe),
		pe
	...
	(function (e, t) {
		...
		function p(e) {
			...
			if (f || p) {
				var m = t(e);
				(f -= u(m, "x")), (p -= u(m, "y")), (o.width -= f), (o.height -= p);
			}
			return h(o);
		}
		function m(e, n) {
		...
		function w(e, t, n, i, r) {
			...
			var s = y(n, i, o, r),
				...
				l = Object.keys(a)
					.map(function (e) {
						return oe({ key: e }, a[e], { area: b(a[e]) });
					})
					.sort(function (e, t) {
		...
		function I(e, t, n, r) {
			...
			var o = i(e);
			return (
				O(o, "scroll", n.updateBound, n.scrollParents),
				(n.scrollElement = o),
				(n.eventsEnabled = !0),
				n
			);
			...
			ce = (function () {
				function t(n, i) {
					...
					ne(this, t),
						...
						Object.keys(oe({}, t.Defaults.modifiers, o.modifiers)).forEach(
							function (e) {
								r.options.modifiers[e] = oe(
									{},
					...
					computeStyle: {
						...
						fn: function (e, t) {
							...
							var a,
								...
								g = D("transform");
							if (
								((l = "bottom" == h ? -u.height + d.bottom : d.top),
								...
								var v = "bottom" == h ? -1 : 1,
									y = "right" == m ? -1 : 1;
								(f[h] = l * v), (f[m] = a * y), (f.willChange = h + ", " + m);
							}
							var b = { "x-placement": e.placement };
							return (
								(e.attributes = oe({}, b, e.attributes)),
		...
		var s,
				...
				(m = (function () {
					...
					return (
						...
						(t._removeElement = function (e) {
							var t = this;
							if ((s(e).removeClass(p), s(e).hasClass(h))) {
								var n = Wn.getTransitionDurationFromElement(e);
								s(e)
									.one(Wn.TRANSITION_END, function (n) {
			...
			Bn =
				...
				(D = {
					...
					FOCUS_BLUR_DATA_API: (T = "focus") + b + w + " blur" + b + w,
				}),
				(N = (function () {
					function e(e) {
						this._element = e;
					...
					return (
						(t.toggle = function () {
							...
							t &&
								...
								e && g(this._element).toggleClass(x);
						}),
						(t.dispose = function () {
						...
						(e._jQueryInterface = function (t) {
							return this.each(function () {
								var n = g(this).data(y);
								n || ((n = new e(this)), g(this).data(y, n)),
									"toggle" === t && n[t]();
							});
						}),
						r(e, null, [
				...
				g(document)
					.on(D.CLICK_DATA_API, C, function (e) {
						e.preventDefault();
						var t = e.target;
						g(t).hasClass("btn") || (t = g(t).closest(k)),
							N._jQueryInterface.call(g(t), "toggle");
					})
					.on(D.FOCUS_BLUR_DATA_API, C, function (e) {
						var t = g(e.target).closest(k)[0];
						g(t).toggleClass(T, /^focus(in)?$/.test(e.type));
					}),
				(g.fn[v] = N._jQueryInterface),
				(g.fn[v].Constructor = N),
				(g.fn[v].noConflict = function () {
					return (g.fn[v] = _), N._jQueryInterface;
				}),
				N),
			Kn =
				((I = "carousel"),
				...
				(K = {
					...
					TOUCHEND: "touchend" + q,
					LOAD_DATA_API: "load" + q + P,
					CLICK_DATA_API: "click" + q + P,
				}),
				($ = "carousel"),
				(Q = "active"),
				(z = "slide"),
					...
					return (
						...
						(t.nextWhenVisible = function () {
							!document.hidden &&
								...
								"hidden" !== O(this._element).css("visibility") &&
								this.next();
						}),
						(t.prev = function () {
						...
						(t.pause = function (e) {
							e || (this._isPaused = !0),
								this._element.querySelector(te) &&
									(Wn.triggerTransitionEnd(this._element), this.cycle(!0)),
						...
						(t._getConfig = function (e) {
							return (e = o({}, R, e)), Wn.typeCheckConfig(I, e, M), e;
						}),
						(t._addEventListeners = function () {
							var e = this;
							this._config.keyboard &&
								O(this._element).on(K.KEYDOWN, function (t) {
									return e._keydown(t);
								}),
								"hover" === this._config.pause &&
									...
									"ontouchstart" in document.documentElement &&
										O(this._element).on(K.TOUCHEND, function () {
											e.pause(),
						...
						(t._slide = function (e, t) {
							...
							if (
								...
								if (O(this._element).hasClass(z)) {
									O(l).addClass(i),
										Wn.reflow(l),
										O(s).addClass(n),
										O(l).addClass(n);
									var d = Wn.getTransitionDurationFromElement(s);
									O(s)
										.one(Wn.TRANSITION_END, function () {
											O(l)
												.removeClass(n + " " + i)
												.addClass(Q),
												O(s).removeClass(Q + " " + i + " " + n),
												(o._isSliding = !1),
												setTimeout(function () {
						...
						(e._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									(n || ((n = new e(this, i)), O(this).data(L, n)),
									"number" == typeof t)
								)
									n.to(t);
				...
				O(window).on(K.LOAD_DATA_API, function () {
					for (
						var e = [].slice.call(document.querySelectorAll(re)),
							t = 0,
							n = e.length;
						t < n;
						t++
				...
				(O.fn[I] = oe._jQueryInterface),
				(O.fn[I].Constructor = oe),
				(O.fn[I].noConflict = function () {
					return (O.fn[I] = H), oe._jQueryInterface;
				}),
				oe),
			$n =
				((ae = "collapse"),
					...
					return (
							...
							if (
								!(
									...
									(this._parent &&
										...
										(t = null),
									t &&
										(n = se(t).not(this._selector).data(le)) &&
										n._isTransitioning)
								)
							) {
								var r = se.Event(he.SHOW);
								if ((se(this._element).trigger(r), !r.isDefaultPrevented())) {
									t &&
										(e._jQueryInterface.call(se(t).not(this._selector), "hide"),
										n || se(t).data(le, null));
									var o = this._getDimension();
									se(this._element).removeClass(me).addClass(ge),
									...
									se(this._element)
										.one(Wn.TRANSITION_END, function () {
											se(i._element).removeClass(ge).addClass(me).addClass(pe),
												(i._element.style[o] = ""),
												i.setTransitioning(!1),
												se(i._element).trigger(he.SHOWN);
										})
										...
										for (var r = 0; r < i; r++) {
											...
											null !== s &&
												(se(
													...
													se(o).addClass(ve).attr("aria-expanded", !1));
										}
									this.setTransitioning(!0), (this._element.style[n] = "");
									var a = Wn.getTransitionDurationFromElement(this._element);
									se(this._element)
										.one(Wn.TRANSITION_END, function () {
						...
						(t._getConfig = function (e) {
							return (
								...
								Wn.typeCheckConfig(ae, e, de),
								e
							);
						}),
						(t._getDimension = function () {
							return se(this._element).hasClass(ye) ? ye : "height";
						}),
						(t._getParent = function () {
							var t = this,
								n = null;
							Wn.isElement(this._config.parent)
						...
						(e._jQueryInterface = function (t) {
							return this.each(function () {
								var n = se(this),
									i = n.data(le),
									r = o({}, fe, n.data(), "object" == typeof t && t ? t : {});
								if (
									(!i && r.toggle && /show|hide/.test(t) && (r.toggle = !1),
									i || ((i = new e(this, r)), n.data(le, i)),
									"string" == typeof t)
								) {
									if (void 0 === i[t])
				...
				se(document).on(he.CLICK_DATA_API, _e, function (e) {
					...
					se(i).each(function () {
						...
						xe._jQueryInterface.call(e, n);
					});
				}),
				(se.fn[ae] = xe._jQueryInterface),
				(se.fn[ae].Constructor = xe),
				(se.fn[ae].noConflict = function () {
					return (se.fn[ae] = ue), xe._jQueryInterface;
				}),
				xe),
			Qn =
				((Te = "dropdown"),
				...
				(De = {
					...
					SHOWN: "shown" + je,
					CLICK: "click" + je,
					CLICK_DATA_API: "click" + je + Se,
					KEYDOWN_DATA_API: "keydown" + je + Se,
					KEYUP_DATA_API: "keyup" + je + Se,
				}),
				(Ne = "disabled"),
				(Oe = "show"),
				(Ie = "dropup"),
				...
				(Ge = (function () {
					...
					return (
						(t.toggle = function () {
							if (!this._element.disabled && !Ee(this._element).hasClass(Ne)) {
								var t = e._getParentFromElement(this._element),
									i = Ee(this._menu).hasClass(Oe);
								if ((e._clearMenus(), !i)) {
									var r = { relatedTarget: this._element },
										o = Ee.Event(De.SHOW, r);
									if ((Ee(t).trigger(o), !o.isDefaultPrevented())) {
										if (!this._inNavbar) {
											if (void 0 === n)
												throw new TypeError(
											...
											"parent" === this._config.reference
												? (s = t)
												: Wn.isElement(this._config.reference) &&
										...
										"ontouchstart" in document.documentElement &&
											0 === Ee(t).closest(We).length &&
											Ee(document.body)
												.children()
												.on("mouseover", null, Ee.noop),
											this._element.focus(),
											this._element.setAttribute("aria-expanded", !0),
											Ee(this._menu).toggleClass(Oe),
											Ee(t).toggleClass(Oe).trigger(Ee.Event(De.SHOWN, r));
									}
								}
							}
						}),
						(t.dispose = function () {
							Ee.removeData(this._element, Ce),
								Ee(this._element).off(je),
								(this._element = null),
						...
						(t._addEventListeners = function () {
							var e = this;
							Ee(this._element).on(De.CLICK, function (t) {
						...
						(t._getConfig = function (e) {
							return (
								(e = o(
									...
									Ee(this._element).data(),
									e
								)),
								Wn.typeCheckConfig(Te, e, this.constructor.DefaultType),
								e
							);
						}),
						...
						(t._getPlacement = function () {
							...
							return (
								e.hasClass("dropup")
									? ((t = Be), Ee(this._menu).hasClass(Pe) && (t = Ke))
									: e.hasClass(Le)
									? (t = ze)
									: e.hasClass(qe)
									? (t = Xe)
									: Ee(this._menu).hasClass(Pe) && (t = Qe),
								t
							);
						}),
									...
									if ((t && "click" === t.type && (a.clickEvent = t), s)) {
										...
										if (
											...
											!(
												...
												Ee.contains(o, t.target)
											)
										) {
											var c = Ee.Event(De.HIDE, a);
											Ee(o).trigger(c),
												c.isDefaultPrevented() ||
													("ontouchstart" in document.documentElement &&
														Ee(document.body)
															.children()
															.off("mouseover", null, Ee.noop),
													n[i].setAttribute("aria-expanded", "false"),
													Ee(l).removeClass(Oe),
													Ee(o)
														.removeClass(Oe)
														.trigger(Ee.Event(De.HIDDEN, a)));
										}
									}
								}
						}),
						...
						(e._dataApiKeydownHandler = function (t) {
							if (
									...
									? !(
											...
											(27 !== t.which &&
												((40 !== t.which && 38 !== t.which) ||
													Ee(t.target).closest(Fe).length))
									  )
									: ke.test(t.which)) &&
								(t.preventDefault(),
								t.stopPropagation(),
								!this.disabled && !Ee(this).hasClass(Ne))
							) {
								...
								if (
									...
									var r = [].slice.call(n.querySelectorAll(Ue));
									if (0 !== r.length) {
				...
				Ee(document)
					...
					.on(De.CLICK_DATA_API + " " + De.KEYUP_DATA_API, Ge._clearMenus)
					.on(De.CLICK_DATA_API, Re, function (e) {
						e.preventDefault(),
							e.stopPropagation(),
							Ge._jQueryInterface.call(Ee(this), "toggle");
					})
					.on(De.CLICK_DATA_API, Me, function (e) {
						e.stopPropagation();
					}),
				(Ee.fn[Te] = Ge._jQueryInterface),
				(Ee.fn[Te].Constructor = Ge),
				(Ee.fn[Te].noConflict = function () {
					return (Ee.fn[Te] = Ae), Ge._jQueryInterface;
				}),
				Ge),
			zn =
				((Ze = "modal"),
					...
					return (
						...
						(t.show = function (e) {
							...
							if (!this._isTransitioning && !this._isShown) {
								Je(this._element).hasClass(ct) && (this._isTransitioning = !0);
						...
						(t.hide = function (e) {
							...
							if (
								...
								if (
									...
									this._isShown = !1;
									var i = Je(this._element).hasClass(ct);
									if (
										(i && (this._isTransitioning = !0),
										this._setEscapeEvent(),
										this._setResizeEvent(),
										Je(document).off(ot.FOCUSIN),
										Je(this._element).removeClass(ut),
										Je(this._element).off(ot.CLICK_DISMISS),
										Je(this._dialog).off(ot.MOUSEDOWN_DISMISS),
										i)
									) {
										var r = Wn.getTransitionDurationFromElement(this._element);
										Je(this._element)
											.one(Wn.TRANSITION_END, function (e) {
						...
						(t.dispose = function () {
							Je.removeData(this._element, et),
								Je(window, document, this._element, this._backdrop).off(tt),
								(this._config = null),
								(this._element = null),
								(this._dialog = null),
								(this._backdrop = null),
						...
						(t._getConfig = function (e) {
							return (e = o({}, it, e)), Wn.typeCheckConfig(Ze, e, rt), e;
						}),
						(t._showElement = function (e) {
							var t = this,
								n = Je(this._element).hasClass(ct);
							(this._element.parentNode &&
								...
								n && Wn.reflow(this._element),
								Je(this._element).addClass(ut),
						...
						(t._enforceFocus = function () {
							...
							Je(document)
								...
								.on(ot.FOCUSIN, function (t) {
									document !== t.target &&
										e._element !== t.target &&
										0 === Je(e._element).has(t.target).length &&
										e._element.focus();
								});
						}),
						(t._setEscapeEvent = function () {
							...
							this._isShown && this._config.keyboard
								? Je(this._element).on(ot.KEYDOWN_DISMISS, function (t) {
						...
						(t._setResizeEvent = function () {
							var e = this;
							this._isShown
								? Je(window).on(ot.RESIZE, function (t) {
						...
						(t._removeBackdrop = function () {
							this._backdrop &&
								(Je(this._backdrop).remove(), (this._backdrop = null));
						}),
						(t._showBackdrop = function (e) {
							var t = this,
								n = Je(this._element).hasClass(ct) ? ct : "";
							if (this._isShown && this._config.backdrop) {
								if (
									...
									Je(this._element).on(ot.CLICK_DISMISS, function (e) {
									...
									n && Wn.reflow(this._backdrop),
									Je(this._backdrop).addClass(ut),
									!e)
								)
									return;
								if (!n) return void e();
								...
								Je(this._backdrop)
									.one(Wn.TRANSITION_END, e)
									.emulateTransitionEnd(i);
							} else if (!this._isShown && this._backdrop) {
								Je(this._backdrop).removeClass(ut);
								var r = function () {
									t._removeBackdrop(), e && e();
								};
								if (Je(this._element).hasClass(ct)) {
						...
						(t._setScrollbar = function () {
							...
							if (this._isBodyOverflowing) {
								...
								Je(t).each(function (t, n) {
									var i = n.style.paddingRight,
										r = Je(n).css("padding-right");
									Je(n)
									...
									Je(n).each(function (t, n) {
										var i = n.style.marginRight,
											r = Je(n).css("margin-right");
										Je(n)
											.data("margin-right", i)
											.css(
												"margin-right",
								...
								var i = document.body.style.paddingRight,
									r = Je(document.body).css("padding-right");
								Je(document.body)
									.data("padding-right", i)
									.css(
										"padding-right",
						...
						(t._resetScrollbar = function () {
							...
							Je(e).each(function (e, t) {
								...
								Je(t).removeData("padding-right"),
									(t.style.paddingRight = n || "");
							});
							var t = [].slice.call(document.querySelectorAll("" + mt));
							Je(t).each(function (e, t) {
								var n = Je(t).data("margin-right");
								void 0 !== n &&
									Je(t).css("margin-right", n).removeData("margin-right");
							});
							var n = Je(document.body).data("padding-right");
							Je(document.body).removeData("padding-right"),
						...
						(e._jQueryInterface = function (t, n) {
							return this.each(function () {
								...
								if (
									(i || ((i = new e(this, r)), Je(this).data(et, i)),
									"string" == typeof t)
								) {
									if (void 0 === i[t])
										throw new TypeError('No method named "' + t + '"');
				...
				Je(document).on(ot.CLICK_DATA_API, dt, function (e) {
					...
					var r = Je(t).data(et)
						? "toggle"
						: o({}, Je(t).data(), Je(this).data());
					("A" !== this.tagName && "AREA" !== this.tagName) ||
						e.preventDefault();
					var s = Je(t).one(ot.SHOW, function (e) {
						e.isDefaultPrevented() ||
							s.one(ot.HIDDEN, function () {
								Je(n).is(":visible") && n.focus();
							});
					});
					gt._jQueryInterface.call(Je(t), r, this);
				}),
				(Je.fn[Ze] = gt._jQueryInterface),
				(Je.fn[Ze].Constructor = gt),
				(Je.fn[Ze].noConflict = function () {
					return (Je.fn[Ze] = nt), gt._jQueryInterface;
				}),
				gt),
			Xn =
				((yt = "tooltip"),
					...
					return (
							...
							if (this._isEnabled)
								if (e) {
									...
									n ||
										...
										vt(e.currentTarget).data(t, n)),
										(n._activeTrigger.click = !n._activeTrigger.click),
										n._isWithActiveTrigger()
											? n._enter(null, n)
											: n._leave(null, n);
								} else {
									if (vt(this.getTipElement()).hasClass(Nt))
						...
						(t.dispose = function () {
							clearTimeout(this._timeout),
								vt.removeData(this.element, this.constructor.DATA_KEY),
								vt(this.element).off(this.constructor.EVENT_KEY),
								vt(this.element).closest(".modal").off("hide.bs.modal"),
								this.tip && vt(this.tip).remove(),
						...
						(t.show = function () {
							var e = this;
							if ("none" === vt(this.element).css("display"))
							...
							if (this.isWithContent() && this._isEnabled) {
								...
								r.setAttribute("id", o),
									...
									this.setContent(),
									this.config.animation && vt(r).addClass(Dt);
								var s =
								...
								var l =
									!1 === this.config.container
										? document.body
										: vt(document).find(this.config.container);
								vt(r).data(this.constructor.DATA_KEY, this),
									vt.contains(
										this.element.ownerDocument.documentElement,
										this.tip
									) || vt(r).appendTo(l),
									vt(this.element).trigger(this.constructor.Event.INSERTED),
									...
									vt(r).addClass(Nt),
									"ontouchstart" in document.documentElement &&
										vt(document.body).children().on("mouseover", null, vt.noop);
								var c = function () {
									e.config.animation && e._fixTransition();
									var t = e._hoverState;
									(e._hoverState = null),
										vt(e.element).trigger(e.constructor.Event.SHOWN),
										t === At && e._leave(null, e);
								};
								if (vt(this.tip).hasClass(Dt)) {
									var u = Wn.getTransitionDurationFromElement(this.tip);
									vt(this.tip)
										.one(Wn.TRANSITION_END, c)
							...
							var t = this,
								...
								r = function () {
									t._hoverState !== St &&
										...
										vt(t.element).trigger(t.constructor.Event.HIDDEN),
							...
							if ((vt(this.element).trigger(i), !i.isDefaultPrevented())) {
								if (
									...
									"ontouchstart" in document.documentElement &&
										vt(document.body)
											.children()
											.off("mouseover", null, vt.noop),
									(this._activeTrigger.click = !1),
									(this._activeTrigger[qt] = !1),
									(this._activeTrigger[Lt] = !1),
									vt(this.tip).hasClass(Dt))
								) {
									var o = Wn.getTransitionDurationFromElement(n);
									vt(n).one(Wn.TRANSITION_END, r).emulateTransitionEnd(o);
								} else r();
								this._hoverState = "";
							}
						}),
						...
						(t.addAttachmentClass = function (e) {
							vt(this.getTipElement()).addClass(xt + "-" + e);
						}),
						...
						(t.setContent = function () {
							...
							this.setElementContent(
								vt(e.querySelectorAll(Ot)),
								this.getTitle()
							),
								vt(e).removeClass(Dt + " " + Nt);
						}),
						(t.setElementContent = function (e, t) {
							var n = this.config.html;
							"object" == typeof t && (t.nodeType || t.jquery)
								? n
									? vt(t).parent().is(e) || e.empty().append(t)
									: e.text(vt(t).text())
								: e[n ? "html" : "text"](t);
						}),
						(t.getTitle = function () {
						...
						(t._enter = function (e, t) {
							...
							(t = t || vt(e.currentTarget).data(n)) ||
								((t = new this.constructor(
									e.currentTarget,
									this._getDelegateConfig()
								)),
								vt(e.currentTarget).data(n, t)),
								e && (t._activeTrigger["focusin" === e.type ? qt : Lt] = !0),
								vt(t.getTipElement()).hasClass(Nt) || t._hoverState === St
									? (t._hoverState = St)
						...
						(t._leave = function (e, t) {
							...
							(t = t || vt(e.currentTarget).data(n)) ||
								...
								vt(e.currentTarget).data(n, t)),
								e && (t._activeTrigger["focusout" === e.type ? qt : Lt] = !1),
							...
							return (
								"number" ==
									typeof (e = o(
										{},
										this.constructor.Default,
										vt(this.element).data(),
										"object" == typeof e && e ? e : {}
									)).delay && (e.delay = { show: e.delay, hide: e.delay }),
								"number" == typeof e.title && (e.title = e.title.toString()),
								"number" == typeof e.content &&
									(e.content = e.content.toString()),
								Wn.typeCheckConfig(yt, e, this.constructor.DefaultType),
								e
							);
						}),
						...
						(e._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									...
									(n || ((n = new e(this, i)), vt(this).data(bt, n)),
									"string" == typeof t)
								) {
									if (void 0 === n[t])
										throw new TypeError('No method named "' + t + '"');
				...
				(vt.fn[yt] = Rt._jQueryInterface),
				(vt.fn[yt].Constructor = Rt),
				(vt.fn[yt].noConflict = function () {
					return (vt.fn[yt] = _t), Rt._jQueryInterface;
				}),
				Rt),
			Vn =
				((Ft = "popover"),
				...
				(zt = o({}, Xn.DefaultType, { content: "(string|element|function)" })),
				(Xt = "fade"),
				(Yt = ".popover-header"),
				(Gt = ".popover-body"),
				(Jt = {
				...
				(Zt = (function (e) {
					...
					return (
						...
						(o.addAttachmentClass = function (e) {
							Mt(this.getTipElement()).addClass(Kt + "-" + e);
						}),
						(o.getTipElement = function () {
							return (
								(this.tip = this.tip || Mt(this.config.template)[0]), this.tip
							);
						}),
						(o.setContent = function () {
							...
							"function" == typeof t && (t = t.call(this.element)),
								this.setElementContent(e.find(Gt), t),
						...
						(t._jQueryInterface = function (e) {
							return this.each(function () {
								var n = Mt(this).data(Wt),
									i = "object" == typeof e ? e : null;
								if (
									(n || !/destroy|hide/.test(e)) &&
									(n || ((n = new t(this, i)), Mt(this).data(Wt, n)),
									"string" == typeof e)
								) {
									if (void 0 === n[e])
				...
				(Mt.fn[Ft] = Zt._jQueryInterface),
				(Mt.fn[Ft].Constructor = Zt),
				(Mt.fn[Ft].noConflict = function () {
					return (Mt.fn[Ft] = Bt), Zt._jQueryInterface;
				}),
				Zt),
			Yn =
				((tn = "scrollspy"),
				...
				(xn = (function () {
					...
					return (
						...
						(t._getConfig = function (e) {
							if (
								"string" !=
								typeof (e = o({}, sn, "object" == typeof e && e ? e : {}))
									.target
							) {
								var t = en(e.target).attr("id");
								t || ((t = Wn.getUID(tn)), en(e.target).attr("id", t)),
									(e.target = "#" + t);
							}
							return Wn.typeCheckConfig(tn, e, an), e;
						}),
						...
						(t._activate = function (e) {
							...
							n.hasClass(cn)
								? (n.closest(vn).find(bn).addClass(un), n.addClass(un))
								: (n.addClass(un),
								  n
										.parents(hn)
										.prev(pn + ", " + gn)
										.addClass(un),
								  n.parents(hn).prev(mn).children(pn).addClass(un)),
				...
				(en.fn[tn] = xn._jQueryInterface),
				(en.fn[tn].Constructor = xn),
				(en.fn[tn].noConflict = function () {
					return (en.fn[tn] = on), xn._jQueryInterface;
				}),
				xn),
			Gn =
				((Cn = "." + (Tn = "bs.tab")),
						...
						(t.show = function () {
							...
							if (
								!(
									(this._element.parentNode &&
										this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
										En(this._element).hasClass(kn)) ||
									En(this._element).hasClass(Dn)
								)
							) {
								var t,
									n,
									i = En(this._element).closest(Ln)[0],
									r = Wn.getSelectorFromElement(this._element);
								if (i) {
									var o = "UL" === i.nodeName ? Pn : qn;
									n = (n = En.makeArray(En(i).find(o)))[n.length - 1];
								}
								var s = En.Event(Sn.HIDE, { relatedTarget: this._element }),
									a = En.Event(Sn.SHOW, { relatedTarget: n });
								if (
									(n && En(n).trigger(s),
									En(this._element).trigger(a),
									!a.isDefaultPrevented() && !s.isDefaultPrevented())
								) {
									r && (t = document.querySelector(r)),
										this._activate(this._element, i);
									var l = function () {
										var t = En.Event(Sn.HIDDEN, { relatedTarget: e._element }),
											i = En.Event(Sn.SHOWN, { relatedTarget: n });
										En(n).trigger(t), En(e._element).trigger(i);
									};
						...
						(t._activate = function (e, t, n) {
							var i = this,
								r = ("UL" === t.nodeName
									? En(t).find(Pn)
									: En(t).children(qn))[0],
								o = n && r && En(r).hasClass("fade"),
								s = function () {
									return i._transitionComplete(e, r, n);
								};
							if (r && o) {
								var a = Wn.getTransitionDurationFromElement(r);
								En(r).one(Wn.TRANSITION_END, s).emulateTransitionEnd(a);
							} else s();
						}),
						(t._transitionComplete = function (e, t, n) {
							if (t) {
								En(t).removeClass(On + " " + kn);
								var i = En(t.parentNode).find(Mn)[0];
								i && En(i).removeClass(kn),
							...
							if (
								...
								Wn.reflow(e),
								En(e).addClass(On),
								e.parentNode && En(e.parentNode).hasClass(An))
							) {
								var r = En(e).closest(In)[0];
								if (r) {
									var o = [].slice.call(r.querySelectorAll(Rn));
									En(o).addClass(kn);
								}
				...
				En(document).on(Sn.CLICK_DATA_API, Hn, function (e) {
					e.preventDefault(), Fn._jQueryInterface.call(En(this), "show");
				}),
				(En.fn.tab = Fn._jQueryInterface),
				(En.fn.tab.Constructor = Fn),
				(En.fn.tab.noConflict = function () {
					return (En.fn.tab = jn), Fn._jQueryInterface;
				}),
				Fn);
		!(function (e) {
			if (void 0 === e)
	...
	function () {
			...
			w = {
				...
				_ = function () {
					...
					for (
						t = arguments[0],
							o = 0,
							s = (i = 2 <= arguments.length ? V.call(arguments, 1) : [])
								.length;
						s > o;
						o++
					)
				...
				g = function (e) {
					var t, n, i, r, o;
					for (n = t = 0, r = 0, o = e.length; o > r; r++)
						(i = e[r]), (n += Math.abs(i)), t++;
					return n / t;
				},
				E = function (e, t) {
					var n, i, r;
				...
				window.Pace = c,
				_(c, s.prototype),
				k = c.options = _({}, w, window.paceOptions, E()),
				U = 0,
				K = (Q = ["ajax", "document", "eventLag", "elements"]).length;
			K > U;
			U++
		)
			(P = Q[U]), !0 === k[P] && (k[P] = w[P]);
		(l = (function (e) {
			...
			(t = (function () {
				...
				return (
					(e.prototype.getElement = function () {
						var e;
						if (null == this.el) {
							if (!(e = document.querySelector(k.target))) throw new l();
					...
					(e.prototype.render = function () {
						...
						for (
							e = this.getElement(),
								...
								r = 0,
								o = (s = ["webkitTransform", "msTransform", "transform"])
									.length;
							o > r;
							r++
						)
							(t = s[r]), (e.children[0].style[t] = i);
						return (
				...
				return (
					(e.prototype.trigger = function (e, t) {
						...
						if (null != this.bindings[e]) {
							for (s = [], i = 0, r = (o = this.bindings[e]).length; r > i; i++)
								(n = o[i]), s.push(n.call(this, t));
							return s;
						}
					}),
			...
			(q = function (e) {
				var t;
				if ((null == e && (e = "GET"), "track" === j[0])) return "force";
				if (!j.length && k.ajax) {
					if ("socket" === e && k.ajax.trackWebSockets) return !0;
					if (((t = e.toUpperCase()), J.call(k.ajax.trackMethods, t) >= 0))
						return !0;
				}
				return !1;
			}),
			(u = (function (e) {
				function t() {
						...
						(e = function (e) {
							...
							return (
								...
								(e.open = function (i, r) {
									return (
										q(i) &&
											n.trigger("request", { type: i, url: r, request: e }),
										t.apply(e, arguments)
									);
								})
							);
					...
					if (null != M && k.ajax.trackWebSockets) {
						window.WebSocket = function (e, t) {
							var i;
							return (
								(i = null != t ? new M(e, t) : new M(e)),
								q("socket") &&
									n.trigger("request", {
										type: "socket",
										url: e,
			...
			(L = function (e) {
				var t, n, i, r;
				for (n = 0, i = (r = k.ajax.ignoreURLs).length; i > n; n++)
			...
			(T = function () {
				...
				return (
					...
					L(s)
						? void 0
						: c.running || (!1 === k.restartOnRequestAfter && "force" !== q(o))
						? void 0
						: ((i = arguments),
						  "boolean" == typeof (n = k.restartOnRequestAfter || 0) && (n = 0),
						  setTimeout(function () {
								var t, n, s, a, l;
								if (
									"socket" === o
										? r.readyState < 2
										: 0 < (s = r.readyState) && 4 > s
								) {
									for (
										c.restart(), l = [], t = 0, n = (a = c.sources).length;
										n > t;
										t++
									) {
					...
					if (((this.progress = 0), null != window.ProgressEvent))
						for (
							e.addEventListener(
								"progress",
								function (e) {
									return (s.progress = e.lengthComputable
			...
			(h = (function () {
				return function (e) {
					var t,
						...
						o = this;
					for (
						this.progress = 0, n = 0, i = (r = ["error", "open"]).length;
						i > n;
						n++
					)
						(t = r[n]),
				...
				return function (e) {
					...
					for (
						null == e && (e = {}),
							...
							n = 0,
							i = (o = e.selectors).length;
						i > n;
						n++
					)
						(t = o[n]), this.elements.push(new r(t));
				};
			})()),
			(r = (function () {
				function e(e) {
			...
			(n = (function () {
				...
				return (
					(e.prototype.states = { loading: 0, interactive: 50, complete: 100 }),
					e
				);
			})()),
			(o = (function () {
					...
					(this.progress = 0),
						...
						(t = setInterval(function () {
							...
							return (
								...
								(n = A()),
								r.push(s),
								r.length > k.eventLag.sampleCount && r.shift(),
								(e = g(r)),
								++i >= k.eventLag.minSamples && e < k.eventLag.lagThreshold
									? ((o.progress = 100), clearInterval(t))
			...
			(d = (function () {
				function e(e) {
					(this.source = e),
						...
						(this.rate = k.initialRate),
						(this.catchup = 0),
						(this.progress = this.lastProgress = 0),
						null != this.source && (this.progress = N(this.source, "progress"));
				}
				return (
						...
						return (
							...
							t === this.last
								...
								: (this.sinceLastUpdate &&
								  ...
								  (this.catchup = (t - this.progress) / k.catchupTime),
								  (this.sinceLastUpdate = 0),
								  (this.last = t)),
							t > this.progress && (this.progress += this.catchup * e),
							(n = 1 - Math.pow(this.progress / 100, k.easeFactor)),
							(this.progress += n * this.rate * e),
							(this.progress = Math.min(
								this.lastProgress + k.maxProgressPerFrame,
								this.progress
							)),
			...
			(c.running = !1),
			(C = function () {
				return k.restartOnPushState ? c.restart() : void 0;
			}),
			...
			(f = { ajax: e, elements: i, document: n, eventLag: o }),
			(S = function () {
				var e, n, i, r, o, s, a, l;
				for (
					c.sources = H = [],
						n = 0,
						r = (s = ["ajax", "elements", "document", "eventLag"]).length;
					r > n;
					n++
				)
					(e = s[n]), !1 !== k[e] && H.push(new f[e](k[e]));
				for (
					i = 0, o = (l = null != (a = k.extraSources) ? a : []).length;
					o > i;
					i++
				)
					(P = l[i]), H.push(new P(k));
			...
			(c.go = function () {
				...
				return (
					...
					(m = O(function (t, n) {
						...
						for (
							100 - v.progress, r = p = 0, o = !0, l = m = 0, b = H.length;
							b > m;
							l = ++m
						)
							for (
						...
						return (
							...
							v.done() || o || y
								? (v.update(100),
								  ...
								  }, Math.max(k.ghostTime, Math.max(k.minTime - (A() - e), 0))))
								: n()
						);
					}))
				);
		...
		})()(
			{
						...
						if (
							...
							(p.prototype = {
								...
								forEachSelectors: function (t, n, i) {
									return e("./lib/foreach-selectors.js").bind(this)(
								...
								switchSelectors: function (t, n, i, r) {
									return e("./lib/switches-selectors.js").bind(this)(
							...
							for (var g in p.prototype)
								p.prototype.hasOwnProperty(g) &&
									"function" == typeof p.prototype[g] &&
									(m[g] = h);
							t.exports = m;
						}
					},
				...
				4: [
					function (e, t, n) {
						...
						t.exports = function (e, t, n, r) {
							(t = "string" == typeof t ? t.split(" ") : t).forEach(function (
								t
							) {
								i(e, function (e) {
							...
							"script" === e.tagName.toLowerCase() && r(e),
								i(e.querySelectorAll("script"), function (e) {
									(e.type && "text/javascript" !== e.type.toLowerCase()) ||
										(e.parentNode && e.parentNode.removeChild(e), r(e));
								});
						};
					},
				...
				11: [
					function (e, t, n) {
										...
										if (
											...
											if ("select" === r)
												for (var a, l = 0; l < i.options.length; l++)
													(a = i.options[l]).selected &&
														s.push(a.value || a.text);
											else s.push(i.value);
						...
						function r(e, t) {
							return e.protocol !== window.location.protocol ||
						...
						var o = e("../events/on"),
							...
							a = function (e, t) {
								if (!l(t)) {
									...
									n.requestOptions = {
										requestUrl:
											e.getAttribute("action") || window.location.href,
									...
									a
										...
										: (t.preventDefault(),
										  "multipart/form-data" === e.enctype
												...
												: (n.requestOptions.requestParams = i(e)),
					...
					function (e, t, n) {
						...
						t.exports = function (e, t, n, s) {
							if (((s = i(s || this.options)), (s.request = t), !1 !== e)) {
								...
								var u = c.hash;
								(c.href = n),
									u && !c.hash && ((c.hash = u), (n = c.href)),
									(this.state.href = n),
									(this.state.options = s);
								try {
									this.loadContent(e, this.options);
								} catch (e) {
									if ((o(document, "pjax:error", s), this.options.debug))
										throw e;
									return (
										console &&
											console.error &&
						...
						t.exports = function (e, t, n) {
							...
							if (
								((u.onreadystatechange = function () {
									4 === u.readyState &&
										(200 === u.status
											? n(u.responseText, u, e, t)
											: 0 !== u.status && n(null, u, e, t));
								}),
					...
					function (e, t, n) {
						...
						t.exports = function (e, t, n, o, s, a) {
							...
							n.forEach(function (n) {
								...
								if (
									(this.log && this.log("Pjax switch", n, c, u),
									c.length !== u.length)
								)
									throw (
								...
								i(
									...
									function (i, o) {
										...
										var c = e[n]
											? e[n].bind(this, s, i, a, t[n])
											: r.outerHTML.bind(this, s, i, a);
										l.push(c);
									},
									this
								);
									...
									o.call(e.childNodes, function (e) {
										s.push(e),
											e.classList &&
												...
												r.callbacks &&
													r.callbacks.removeElement &&
													r.callbacks.removeElement(e),
												r.classNames &&
													(e.className +=
														" " +
														r.classNames.remove +
														" " +
														(n.backward
															? r.classNames.backward
															: r.classNames.forward)),
												u++,
												i(e, c, f, !0));
									}),
											...
											r.classNames &&
												(t =
													...
													(n.backward
														...
														: r.classNames.backward)),
												r.callbacks &&
													r.callbacks.addElement &&
													r.callbacks.addElement(e),
												(e.className += t),
	...
	(function (e) {
		...
		var t = {
			...
			n = new Pjax({
				...
				switches: { "#main": Pjax.switches.sideBySide },
				switchesOptions: { "#main": t },
			}),
			i = new Pjax({
				cacheBust: !1,
				elements:
			...
			r = new Pjax({
				...
				switchesOptions: { "#content-body": t },
			});
	})(jQuery);
var MODULE_CONFIG = {
		chat: [
...
!(function (e, t) {
		...
		(t.unload = function (t) {
			(t = e.isArray(t) ? t : t.split(/\s+/)),
				e.each(t, function (t, i) {
					i.indexOf(".css") >= 0
						? e('link[href="' + i + '"]').remove()
						: e('script[src="' + i + '"]').remove(),
						delete n[i];
				});
		});
	var o = function (t) {
	...
	(function ($, MODULE_CONFIG, MODULE_OPTION_CONFIG) {
		...
		$.fn.plugin = function () {
			...
			return this.each(function () {
				var e = $(this),
					t = e.attr("data-option") || e.attr("data-plugin-option"),
					n = e.attr("data-plugin");
				e[n] && t
					? e[n].apply(e, getOpts(t, n))
					: lazyload.load(MODULE_CONFIG[n]).then(function () {
							t && e[n].apply(e, getOpts(t, n)),
								e[n] && e[n].init && e[n].init(),
								window[n] && window[n].init && window[n].init();
					  }),
	...
	(function (e) {
		...
		function t() {
			var t = e(".setting");
			e("body")
				.removeClass(e("body").attr("data-class"))
				.addClass(theme.setting.bg)
				.attr("data-class", theme.setting.bg),
				e("#header")
					.removeClass(e("#header").attr("data-class"))
					.addClass(theme.setting.header)
					.attr("data-class", theme.setting.header),
				e("#aside")
					.removeClass(e("#aside").attr("data-class"))
					.addClass(theme.setting.aside)
					.attr("data-class", theme.setting.aside),
				theme.setting.foldedAside
					? e("#aside").addClass("folded")
					: e("#aside").removeClass("folded"),
				theme.setting.hideAside
					? e("#aside").addClass("hide")
					: e("#aside").removeClass("hide"),
				theme.setting.stickyHeader
					? e(".page-header").addClass("sticky")
					: e(".page-header").removeClass("sticky"),
				theme.setting.stickyAside
					? e(".page-sidenav").addClass("sticky")
					: e(".page-sidenav").removeClass("sticky"),
				t
					.find('input[name="foldedAside"]')
					.prop("checked", theme.setting.foldedAside),
				t
					.find('input[name="hideAside"]')
					.prop("checked", theme.setting.hideAside),
				t
					.find('input[name="stickyHeader"]')
					.prop("checked", theme.setting.stickyHeader),
				t
					.find('input[name="stickyAside"]')
					.prop("checked", theme.setting.stickyAside),
				t
					.find('input[name="bg"][value="' + theme.setting.bg + '"]')
					.prop("checked", !0);
		}
		function n(e, t) {
			try {
		...
		/iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(i) &&
			...
			e("body").on("DOMMouseScroll mousewheel", function (t) {
				var n = e("#header");
				t.originalEvent.detail > 0 || t.originalEvent.wheelDelta < 0
					? n.removeClass("scroll-up").addClass("scroll-down")
					: n.removeClass("scroll-down").addClass("scroll-up"),
			...
			e(document).on("click", "[data-nav] a", function (t) {
				...
				(r = (i = o.parent()).parents("li")),
					...
					o.attr("href") &&
						"#" != o.attr("href") &&
						e(document).trigger("Nav:changed");
			}),
			e(document).on("click", "[data-toggle-class]", function (t) {
				...
				e.each(s, function (t, i) {
					var r = o
							? n.closest(a[1 == a.length ? 0 : l])
							: e(a[1 == a.length ? 0 : l]),
						c = r.attr("data-class"),
						u = s[t];
					c != u && r.removeClass(r.attr("data-class")),
						r.toggleClass(s[t]),
						r.attr("data-class", u),
						l++;
				}),
		...
		var r = function () {
			...
			t.length > 0 && (t = t[t.length - 1]),
				e("[data-nav] li.active").removeClass("active"),
				e("[data-nav] a")
					.filter(function () {
		...
		for (
			var s = window.location.search.substring(1).split("&"), a = 0;
			a < s.length;
			a++
		) {
			var l = s[a].split("=");
			(theme.setting[l[0]] =
				"true" == l[1] || "false" == l[1] ? "true" == l[1] : l[1]),
				n(o, theme.setting);
		}
		e(document).on("click.setting", ".setting input", function (i) {
			var r = e(this),
				s = r.attr("name");
			(theme.setting[s] = r.is(":checkbox")
				? r.prop("checked")
				: e(this).val()),
				n(o, theme.setting),
				t(theme.setting);
